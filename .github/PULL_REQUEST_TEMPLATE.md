...
- [ ] Production-supported CLI/JSON/error/exit-code contract changes are documented in `CHANGELOG.md`.
- [ ] Release artifacts or smoke reports have checksums when this is a release-candidate change.
